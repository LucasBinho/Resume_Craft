...
const allTemplates: ResumeTemplates[]= ["ditto", "eevee", "onix", "jynx"];
                    ...
                    {allTemplates.map((template) =>{
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className={cn(
                                    "absolute text-sm inset-0 w-full h-full flex flex-col font-bold font-title items-center justify-end p-2 bg-gradient-to-t from-background capitalize"
                                )}>
                                    {template}
                                </div>
                            </button>
